...
#from brownie import TiketVip

def main():
    test_file = "contracts/TiketVipTest.sol"
    copyfile("contracts/TiketVip.sol", test_file)
    ...
    with open(test_file, "w") as f:
        for line in lines:
            if "contract TiketVip is" in line:
                ...
                f.write(line.replace("contract TiketVip is", "contract TiketVipTest is"))
